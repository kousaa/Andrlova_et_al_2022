...
def calc_QC_metrics(anndata_object):
    ...
    path_to_RB_genes_file = '/data/brinkvd/kousaa/scRNAseq-repository/data_access/RB_genes'
...
def remove_RBs(anndata_object):
    path_to_RBP_genes_file = '/data/brinkvd/kousaa/scRNAseq-repository/data_access/RB_genes'
